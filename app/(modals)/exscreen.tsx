...
const exscreen = () => {
    ...
    async function redirectToUpload({
        uri,
        filetype,
        fileTuru,
    }: {
    ...
    //         storage,
    //         "Stuff/" + filetype + "/" + new Date().getTime() + "." + fileTuru
    ...
    return (
        <View style={{ flex: 1, paddingBottom: 50 }}>
            {image ? (
                <UpLoading progress={progressBar} image={image} />
            ) : video ? (
                <UpLoading progress={progressBar} video={video} />
            ) : (
                <Text style={{ textAlign: "center", fontSize: 26 }}>upload ima ge</Text>
            )}
            <View
                style={{
                    minHeight: 200,
